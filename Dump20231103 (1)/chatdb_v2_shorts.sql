...
CREATE TABLE `shorts` (
  ...
  `short` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `short_content` varchar(500) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
INSERT INTO `shorts` VALUES (9,'d','good',NULL);
