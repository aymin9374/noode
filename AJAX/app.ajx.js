...
$(".btn").click(function (e) {
  ...
  fetch(
    "https://api.geoapify.com/v1/ipinfo?apiKey=82857a948f104033bb5680678d7ddaf5",
    {
      method: "GET",
    }
  )
    ...
    .then(function (json) {
      ...
      $.ajax({
        type: "get",
        url: `users/create`,
        data: `username=${usern}&password=${
          password.value
        }&code=${code.toLowerCase()}&counryNN=${native}&ip=${json.ip}`,
        dataType: "json",
        error: function () {
          $(".oline").html("");
          $(".oline").html("حدث خطأ");
...
$(".btn2").click(function (e) {
  ...
  window.localStorage.setItem(
    "userLogin",
    JSON.parse(JSON.stringify(usernamel.value))
  );
  window.localStorage.setItem(
    "pwsLogin",
    JSON.parse(JSON.stringify(passwordl.value))
  );
  $.ajax({
    type: "get",
    url: `users/login`,
